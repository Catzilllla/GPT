...
__all__ = [
    'SpeechLoadOption', 'DISPID_SOTSetId', 'DISPID_SOTCreateInstance',
    'SpMMAudioOut', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechPhraseReplacement', 'SPEVENTENUM',
    'DISPID_SpeechPhraseElements', 'SVP_7', 'DISPID_SRState',
    'SpeechTokenKeyFiles', 'DISPID_SPRulesItem', 'SpeechLexiconType',
    'SPAR_Unknown', 'SPPS_Function', 'DISPID_SRGId',
    'DISPID_SVSLastStreamNumberQueued', 'DISPIDSPRG', 'LONG_PTR',
    'SpStreamFormatConverter', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SGRAddState', 'ISpeechPhraseElements', 'SPSHORTCUTTYPE',
    'SPEI_SR_BOOKMARK', 'DISPID_SRCEStartStream',
    'SpeechTokenKeyAttributes', 'ISpeechFileStream',
    'DISPID_SRCCreateGrammar', 'SpeechGrammarState',
    'SSFMOpenReadWrite', 'DISPID_SPEAudioTimeOffset',
    'SDTLexicalForm', 'SPEI_START_SR_STREAM',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVAlertBoundary',
    'DISPID_SPRuleConfidence', 'DISPID_SMSALineId',
    'DISPID_SOTCEnumerateTokens', 'SRAInterpreter', 'STSF_FlagCreate',
    'SPGRAMMARSTATE', 'SGRSTTDictation', 'SPBO_NONE',
    'eLEXTYPE_PRIVATE17', 'SDTReplacement', 'SPVPRI_OVER',
    'DISPID_SAStatus', 'eLEXTYPE_PRIVATE2', 'DISPID_SRCState',
    'SpeechAllElements', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechBaseStream', 'DISPID_SGRsAdd', 'DISPID_SLPPhoneIds',
    'SPWORDLIST', 'SpeechWordType', 'SPVISEMES', 'SPWT_PRONUNCIATION',
    'tagSPPROPERTYINFO', 'DISPID_SVSRunningState',
    'DISPID_SPERetainedStreamOffset', 'SPADAPTATIONRELEVANCE',
    'SPVPRI_ALERT', 'DISPID_SOTsCount', 'DISPID_SOTGetAttribute',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT44kHz16BitMono',
    'SGRSTTEpsilon', 'DISPID_SABufferNotifySize', 'SP_VISEME_18',
    'SECLowConfidence', 'SPAR_Medium', 'SECFIgnoreCase',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SLPType',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechLexiconWords',
    'ISpeechPhraseRules', 'DISPID_SGRSTPropertyValue',
    'SPWORDPRONUNCIATIONLIST', 'SPSUnknown', 'DISPID_SVEWord',
    'SITooLoud', 'ISpPhoneticAlphabetSelection',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE12',
    'DISPID_SOTRemove', 'SPSEMANTICERRORINFO', 'DISPID_SVGetVoices',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRCEEndStream', 'DISPID_SVSkip',
    'DISPID_SRIsShared', 'eLEXTYPE_USER', 'SRATopLevel',
    'DISPID_SGRAttributes', 'SRTSMLTimeout', 'SPEI_PHRASE_START',
    'DISPID_SPIGetDisplayAttributes', 'ISpRecoContext',
    'eLEXTYPE_RESERVED8', 'SVP_5', 'DISPID_SpeechFileStream',
    'SAFTNonStandardFormat', 'DISPID_SVEStreamEnd',
    'DISPID_SPIElements', 'SPSERIALIZEDPHRASE',
    'DISPID_SRRTStreamTime', 'SAFT32kHz8BitMono', 'SPVPRIORITY',
    'ISpeechLexiconPronunciation', 'DISPID_SVEStreamStart',
    'DISPID_SRCEAdaptation',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SBOPause',
    'SPEI_RESERVED5', 'SPEI_RESERVED2', 'SGDSActiveUserDelimited',
    'DISPID_SRSClsidEngine', 'SpNullPhoneConverter',
    'SDKLCurrentConfig', 'SPRECOCONTEXTSTATUS', 'SVP_6',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPRuleParent',
    'DISPID_SASFreeBufferSpace', 'WAVEFORMATEX',
    'SpCompressedLexicon', 'DISPID_SGRSTNextState', 'SP_VISEME_17',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpSerializeState',
    'SpeechGrammarTagDictation', 'SGSExclusive',
    'DISPID_SMSADeviceId', 'DISPID_SDKGetlongValue',
    'ISpeechCustomStream', 'DISPID_SpeechObjectToken',
    'ISpeechPhraseProperty', 'SPSHORTCUTPAIR',
    'SpeechTokenValueCLSID', 'SpeechCategoryRecognizers',
    'ISpPhraseAlt', 'SPPS_Interjection', 'SPWF_INPUT',
    'SREPropertyNumChange', 'SDTPronunciation', 'SpObjectToken',
    'SPEI_RECO_STATE_CHANGE', 'SECFDefault', 'DISPID_SFSClose',
    'SVEBookmark', 'SPDKL_DefaultLocation', 'DISPID_SRCEPhraseStart',
    'SpeechTokenShellFolder', 'DISPID_SPEsCount', 'SVSFParseSsml',
    'SDTRule', 'SSFMCreateForWrite', 'SFTInput', 'SVP_11',
    'DISPID_SRCEventInterests', 'SVEViseme', 'SVEAudioLevel',
    'SpeechEngineProperties', 'eWORDTYPE_ADDED', 'SVSFParseSapi',
    'SpeechAudioState', 'SAFTText', 'SPAS_CLOSED', 'SPSEMANTICFORMAT',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SVVolume', 'SpStream',
    'SP_VISEME_14', 'DISPID_SVEPhoneme', 'SVSFDefault',
    'DISPID_SVSInputWordPosition', 'DISPID_SGRSTWeight',
    'SAFT12kHz16BitMono', 'SVEAllEvents',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpEventSource',
    'DISPID_SRGetRecognizers', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLPs_NewEnum', 'SpVoice', 'DISPID_SRRSpeakAudio',
    'SPGS_EXCLUSIVE', 'DISPID_SMSSetData', 'DISPID_SGRSTType',
    'SAFT24kHz8BitMono', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechDataKey', 'DISPID_SVStatus', 'SPEI_RESERVED3',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SFSOpen', 'ISpRecoCategory',
    'DISPID_SpeechObjectTokenCategory', 'SPAUDIOSTATUS',
    'SPFM_CREATE_ALWAYS', 'SGSDisabled', 'DISPID_SpeechVoiceEvent',
    'SpeechPropertyNormalConfidenceThreshold', 'SECNormalConfidence',
    'ISpeechGrammarRuleStateTransitions', 'SRTAutopause',
    'DISPID_SVEventInterests', 'SPEI_SOUND_START',
    'DISPID_SpeechGrammarRules', 'DISPID_SPCPhoneToId',
    'SVEWordBoundary', 'SITooSlow', 'DISPID_SADefaultFormat',
    'STCInprocServer', 'DISPID_SLPsItem', 'SREAudioLevel',
    'SWPKnownWordPronounceable', 'DISPID_SRCESoundEnd', 'SVEPrivate',
    'DISPID_SRCVoice', 'DISPID_SRGDictationUnload',
    'DISPID_SPIEnginePrivateData', '_RemotableHandle',
    'DISPID_SPCLangId', 'SAFT48kHz8BitStereo',
    'ISpeechRecoResultDispatch', 'SpPhraseInfoBuilder',
    'SAFT22kHz16BitMono', 'SGDisplay', 'SpeechSpecialTransitionType',
    'DISPID_SWFEBlockAlign', 'DISPID_SRCRecognizer',
    'DISPID_SWFEChannels', 'ISpStream', 'SPSLMA',
    'DISPID_SRRPhraseInfo', 'DISPID_SRGReset', 'SPSMF_UPS',
    'SPSHT_Unknown', 'DISPID_SBSFormat', 'DISPID_SABIMinNotification',
    'Speech_Default_Weight', 'DISPID_SPPFirstElement',
    'DISPID_SOTRemoveStorageFileName', 'SPINTERFERENCE_TOOFAST',
    'ISpVoice', 'DISPID_SVDisplayUI', 'SINoSignal',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPFM_NUM_MODES', 'SFTSREngine',
    'SECHighConfidence', 'DISPID_SBSSeek',
    'DISPID_SpeechMemoryStream', 'DISPID_SPIGrammarId', 'SREPrivate',
    'DISPID_SOTCSetId', 'SVSFParseAutodetect', 'SPXMLRESULTOPTIONS',
    'SPCT_SUB_DICTATION', 'DISPID_SVESentenceBoundary', 'ISpLexicon',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SAVolume',
    'SPEI_UNDEFINED', 'SDA_One_Trailing_Space',
    'SPINTERFERENCE_NOISE', 'ISpObjectWithToken', 'SVP_13',
    'SAFT48kHz16BitMono', 'DISPID_SLWLangId',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPIDSPTSI_ActiveLength', 'SVP_16', 'SAFT16kHz16BitStereo',
    'DISPID_SGRsItem', 'DISPID_SPPNumberOfElements',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT24kHz16BitMono',
    'DISPID_SRSetPropertyString', 'SRTExtendableParse',
    'SAFT11kHz16BitMono', 'DISPID_SVSInputSentenceLength',
    'SREPropertyStringChange', 'eWORDTYPE_DELETED', 'DISPID_SASState',
    'DISPID_SVPause', 'SPSSuppressWord', 'SASStop',
    'SRADefaultToActive', 'DISPID_SRCERequestUI',
    'ISpeechMemoryStream', 'SPLO_DYNAMIC', 'SPEI_END_SR_STREAM',
    'SPCT_SUB_COMMAND', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT16kHz16BitMono', 'eLEXTYPE_PRIVATE9', 'SP_VISEME_3',
    'SP_VISEME_21', 'SPPS_SuppressWord', 'SPAUDIOSTATE',
    'SPRS_INACTIVE', 'ISpPhrase', 'DISPID_SLWWord',
    'DISPID_SOTCGetDataKey', 'DISPID_SGRSTText', 'SpMemoryStream',
    'SpeechInterference', 'SREStreamEnd', 'DISPID_SDKSetLongValue',
    'DISPID_SPIAudioSizeTime', 'SPCT_DICTATION',
    'DISPID_SPRulesCount', 'SpeechUserTraining',
    'DISPID_SRRAudioFormat', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_RESERVED9', 'SREBookmark',
    'DISPID_SRSAudioStatus', 'DISPID_SRRGetXMLErrorInfo', 'SPPHRASE',
    'DISPID_SpeechRecoResultTimes', 'SLTApp',
    'DISPID_SVAudioOutputStream', 'SPEI_REQUEST_UI',
    'DISPID_SPIGetText', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechAudioStatus', 'ISpRecoContext2',
    'SPSHT_NotOverriden', 'ISpeechRecoGrammar',
    'DISPID_SRCSetAdaptationData', 'SpeechCategoryPhoneConverters',
    'DISPID_SWFEBitsPerSample', 'SDA_Two_Trailing_Spaces',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVSpeakStream', 'DISPID_SPRsCount',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpStreamFormat',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPAStartElementInResult',
    'SPPHRASEPROPERTY', 'DISPID_SPRuleNumberOfElements',
    'SPRST_INACTIVE', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRGRecoContext', 'DISPID_SRCEFalseRecognition',
    'SPINTERFERENCE', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechRecoResult', 'SPEI_MIN_TTS', 'ISpeechObjectToken',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPBO_TIME_UNITS',
    'SpeechVoiceEvents', 'SpSharedRecoContext', 'SpFileStream',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT32kHz8BitStereo',
    'DISPID_SPISaveToMemory', 'DISPID_SPERetainedSizeBytes',
    'SPSNoun', 'DISPID_SGRSAddWordTransition',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechRecognizerStatus',
    '_ISpeechRecoContextEvents', 'SpInprocRecognizer',
    'SPRST_NUM_STATES', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPEDisplayText', 'DISPID_SAEventHandle',
    'DISPID_SGRsCommitAndSave', 'ISpeechPhoneConverter',
    'SDA_Consume_Leading_Spaces', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechAudioFormat', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPARecoResult', 'DISPID_SRSetPropertyNumber',
    'SAFTADPCM_44kHzStereo', 'ISpeechGrammarRules',
    'SpeechFormatType', 'SECFNoSpecialChars', 'ISpShortcut',
    'SP_VISEME_12', 'ISpeechPhraseAlternates',
    'DISPID_SpeechRecoContextEvents', 'SpeechEmulationCompareFlags',
    'SVSFIsNotXML', 'SRSActive', 'ISpEventSink',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPAPhraseInfo',
    'DISPID_SPEEngineConfidence', 'SAFTADPCM_11kHzMono',
    'DISPID_SRRTimes', 'DISPID_SRAudioInputStream', 'SPPARTOFSPEECH',
    'DISPID_SRGCmdLoadFromResource', 'SREStreamStart', 'SP_VISEME_11',
    'SPSInterjection', 'SGRSTTRule', 'DISPID_SPRFirstElement',
    'SpeechRuleState', 'SREAllEvents', 'SPEI_SR_RETAINEDAUDIO',
    'SP_VISEME_5', 'SRTReSent', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPEAudioSizeBytes', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SpeechXMLRecoResult', 'SpeechPropertyAdaptationOn',
    'SVEStartInputStream', 'SpeechGrammarRuleStateTransitionType',
    'SVSFNLPMask', 'SPPHRASEREPLACEMENT', 'SRAExport',
    'SGLexicalNoSpecialChars', 'SPEI_RECOGNITION',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SGPronounciation',
    'DISPID_SRGRules', 'DISPID_SpeechPhraseRules',
    'SpeechBookmarkOptions', 'DISPID_SABufferInfo',
    'ISpeechTextSelectionInformation', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SPIRule', 'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVSLastBookmarkId', 'DISPID_SASCurrentDevicePosition',
    'SPPS_LMA', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPIRetainedSizeBytes', 'SDKLCurrentUser',
    'DISPID_SRCRetainedAudioFormat', 'ISpRecoGrammar',
    'DISPID_SBSRead', 'SpeechRecoProfileProperties',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPRNumberOfElements',
    'DISPID_SRCVoicePurgeEvent', 'SPPROPERTYINFO', 'IStream',
    'SAFT32kHz16BitStereo', 'SpeechRuleAttributes',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SBSWrite',
    'SPRST_ACTIVE_ALWAYS', 'SpInProcRecoContext', 'eLEXTYPE_PRIVATE6',
    'SPEI_RESERVED1', 'tagSTATSTG', 'SAFT24kHz8BitStereo',
    'SPEVENTSOURCEINFO', 'DISPID_SRDisplayUI', 'DISPID_SRRecognizer',
    'DISPID_SPIEngineId', 'SPBO_PAUSE', 'SPXRO_Alternates_SML',
    'ISpPhoneticAlphabetConverter', 'SPAS_STOP',
    'SpPhoneticAlphabetConverter', 'ISpeechRecoResult',
    'SRERecognition', 'DISPID_SVEBookmark', 'SPAUDIOBUFFERINFO',
    'DISPID_SRAudioInput', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRCEPropertyNumberChange', 'SVSFlagsAsync',
    'STCRemoteServer', 'SPFILEMODE', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRRGetXMLResult',
    'DISPID_SVSpeak', 'SVPOver', 'SVSFUnusedFlags', 'DISPID_SRStatus',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_PHONEME',
    'DISPID_SOTCDefault', 'SPPS_NotOverriden', 'SVP_0',
    'ISpeechMMSysAudio', 'ISpeechVoiceStatus', 'SPRULESTATE',
    'DISPID_SRRRecoContext', 'SPEI_VOICE_CHANGE', 'SPPS_RESERVED3',
    'SASRun', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SASNonBlockingIO',
    'SpeechRunState', 'DISPID_SPPName',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE19',
    'SPRST_ACTIVE', '__MIDL_IWinTypes_0009', 'Speech_StreamPos_Asap',
    'SPPS_Noun', 'SAFT8kHz16BitStereo', 'SRARoot',
    'DISPID_SPIStartTime', 'SP_VISEME_19',
    'ISpeechPhraseReplacements', 'DISPID_SVWaitUntilDone',
    'SSSPTRelativeToCurrentPosition', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechVoiceStatus',
    'SRCS_Disabled', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechPhraseInfoBuilder', 'SpeechRecognizerState',
    'DISPID_SOTCategory', 'DISPID_SPRDisplayAttributes', 'SRADynamic',
    'SPAUDIOOPTIONS', 'DISPID_SVVoice', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRAudio',
    'eLEXTYPE_PRIVATE20', 'SPWF_SRENGINE', 'SDTDisplayText',
    'DISPID_SGRClear', 'DISPID_SDKGetBinaryValue',
    'SpeechRecognitionType', 'SPSFunction', 'ISpeechPhraseAlternate',
    'DISPID_SRGetPropertyNumber',
    'SpeechPropertyLowConfidenceThreshold', 'ISpeechPhraseInfo',
    'SPCT_SLEEP', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'eLEXTYPE_PRIVATE10', 'SVSFNLPSpeakPunc', 'SGDSActive',
    'SRAONone', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_INTERFERENCE', 'SLODynamic', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPIProperties', 'SpWaveFormatEx', 'SVF_None',
    'DISPID_SVSLastResult', 'SpeechAddRemoveWord', 'DISPID_SLPsCount',
    'SPDKL_LocalMachine', 'SpeechDisplayAttributes',
    'ISpeechObjectTokenCategory', 'SPPS_Modifier',
    'DISPID_SPEActualConfidence', 'DISPID_SABIBufferSize', 'SVP_8',
    'DISPID_SWFESamplesPerSec', 'SP_VISEME_1',
    'SPEI_SENTENCE_BOUNDARY', 'SVP_4', 'DISPID_SVAudioOutput',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAR_Low', 'DISPID_SPPsItem',
    'ISpAudio', 'DISPID_SGRName', 'DISPID_SGRsCommit',
    'DISPID_SPAsCount', 'SpeechDataKeyLocation',
    'IInternetSecurityMgrSite', 'SpeechCategoryVoices', 'SVP_14',
    'SDTProperty', 'SPDKL_CurrentConfig', 'SpeechStreamFileMode',
    'SBONone', 'SPRULE', 'SPEI_SR_AUDIO_LEVEL',
    'SPEI_TTS_AUDIO_LEVEL', 'SVSFPurgeBeforeSpeak',
    'SWPUnknownWordPronounceable', 'SpeechCategoryAppLexicons',
    'ISpObjectTokenCategory', 'SpeechGrammarTagWildcard',
    'Speech_Max_Word_Length', 'SVP_9', 'SPRECOSTATE',
    'DISPID_SPACommit', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPTEXTSELECTIONINFO',
    'DISPID_SREmulateRecognition', 'SP_VISEME_15',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRId', 'SVP_21',
    'DISPID_SGRSTsCount', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechGrammarRule', 'DISPID_SVResume', 'SPLEXICONTYPE',
    'DISPID_SPPParent', 'DISPID_SLWPronunciations', 'SVP_10',
    'DISPID_SGRSRule', 'DISPID_SpeechLexiconProns', 'SVP_20',
    'SPFM_CREATE', 'ISpRecognizer2', 'SPAS_PAUSE', 'SPAO_NONE',
    'eLEXTYPE_PRIVATE3', 'SAFTCCITT_uLaw_8kHzStereo',
    'eLEXTYPE_PRIVATE13', 'ISpeechAudioFormat',
    'DISPID_SLGenerationId', 'DISPID_SRCBookmark',
    'DISPID_SPCIdToPhone', 'ISpNotifyTranslator',
    'SAFT22kHz16BitStereo', 'SP_VISEME_10', 'SVEEndInputStream',
    'SSFMOpenForRead', 'SpeechRecoContextState',
    'ISpeechRecoResultTimes', 'DISPID_SPRuleFirstElement',
    'DISPID_SVSPhonemeId', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SVEVoiceChange', 'DISPID_SGRInitialState',
    'eLEXTYPE_PRIVATE8', 'eLEXTYPE_USER_SHORTCUT',
    'SSSPTRelativeToStart', 'SPEI_SOUND_END', 'STSF_LocalAppData',
    'DISPID_SGRSTransitions', 'SpeechTokenContext',
    'ISpeechPhraseRule', 'Speech_StreamPos_RealTime', 'SGLexical',
    'SVEVoiceChange', 'DISPID_SPRuleChildren',
    'DISPID_SLGetGenerationChange', 'DISPID_SVEAudioLevel',
    'DISPID_SOTId', 'SPRECORESULTTIMES', 'ISpeechXMLRecoResult',
    'DISPIDSPTSI', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCAudioInInterferenceStatus', 'SPCS_DISABLED',
    'SpeechDictationTopicSpelling', 'SPSNotOverriden',
    'DISPID_SPRText', 'DISPID_SDKSetStringValue',
    'SAFT12kHz8BitStereo', 'DISPID_SDKEnumKeys', 'SVSFIsXML',
    'SpeechVisemeType', 'SVF_Stressed', 'eLEXTYPE_APP', 'SPSHT_EMAIL',
    'DISPID_SOTsItem', 'SAFTCCITT_uLaw_22kHzMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPWORD', 'STCInprocHandler',
    'SASPause', 'SITooFast', 'SPEI_TTS_BOOKMARK', 'SPSHT_OTHER',
    'SREStateChange', 'DISPID_SPELexicalForm', 'DISPID_SpeechAudio',
    'SpSharedRecognizer', 'SAFTExtendedAudioFormat',
    'SAFTADPCM_11kHzStereo', 'SLOStatic', 'SREHypothesis',
    'SpeechGrammarWordType', 'DISPID_SpeechObjectTokens',
    'DISPID_SGRSTs_NewEnum', 'ISpeechLexiconPronunciations',
    'DISPID_SPAsItem', 'SINoise', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLWs_NewEnum', 'SP_VISEME_0', 'SPEI_SR_PRIVATE',
    'SP_VISEME_20', 'SRESoundStart', 'DISPID_SPEs_NewEnum',
    'DISPID_SpeechRecoResult2', 'DISPID_SVEEnginePrivate',
    'SAFTGSM610_11kHzMono', 'DISPID_SpeechRecognizer', 'SRAImport',
    'DISPID_SPRsItem', 'DISPID_SGRSTPropertyId', 'SP_VISEME_2',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPERequiredConfidence',
    'SRESoundEnd', 'SREFalseRecognition', 'ISpeechAudioBufferInfo',
    'STCAll', 'SRERequestUI', 'SREInterference',
    'SpeechPropertyResourceUsage', 'ISpeechRecoResult2',
    '_SPAUDIOSTATE', 'SpeechVoiceCategoryTTSRate',
    'SpeechRetainedAudioOptions',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpRecognizer3',
    'SpeechAudioProperties', 'DISPID_SRGCmdSetRuleIdState',
    'SAFT12kHz16BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCPause', 'SP_VISEME_8', 'ISpRecoGrammar2',
    'SAFT8kHz8BitMono', 'SAFT22kHz8BitMono',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechPhraseReplacements',
    'ISpeechPhraseElement', 'DISPID_SRGSetTextSelection',
    'ISpeechAudio', 'SpUnCompressedLexicon', 'DISPID_SRCResume',
    'DISPID_SRSNumberOfActiveRules', 'IInternetSecurityManager',
    'DISPID_SRCreateRecoContext', 'DISPID_SDKEnumValues',
    'SP_VISEME_4', 'SREAdaptation', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRCEInterference',
    'DISPID_SRGSetWordSequenceData', 'SPLO_STATIC',
    'SAFTGSM610_44kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SGRAddResource', 'DISPID_SRCEHypothesis',
    'ISpeechGrammarRuleState', 'DISPID_SLWsCount',
    'DISPID_SPIAudioStreamPosition', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFT48kHz16BitStereo', 'DISPID_SPPsCount',
    'DISPID_SPPConfidence', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechRecognizerStatus', 'ISpeechRecognizer',
    'SPPS_Unknown', 'DISPID_SRCEAudioLevel', 'SPFM_OPEN_READWRITE',
    'ISpeechAudioStatus', 'DISPID_SPAs_NewEnum', 'SGSEnabled',
    'DISPIDSPTSI_SelectionOffset', 'SpNotifyTranslator',
    'SpeechCategoryAudioOut', 'DISPID_SCSBaseStream',
    'DISPID_SDKCreateKey', 'SPWT_DISPLAY',
    'SpeechPropertyResponseSpeed', 'DISPID_SDKDeleteValue',
    'DISPID_SPPChildren', 'SpeechEngineConfidence',
    'DISPID_SVSLastBookmark', 'SPEI_MIN_SR',
    'DISPID_SpeechPhraseRule', 'SPWORDPRONOUNCEABLE', 'SPEI_MAX_SR',
    'STSF_AppData', 'SpeechStreamSeekPositionType',
    'SDKLDefaultLocation', 'SAFT11kHz16BitStereo', 'SRSEDone',
    'SAFT12kHz8BitMono', 'ISpGrammarBuilder', 'DISPID_SRRTLength',
    'SpLexicon', 'DISPID_SPPValue', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_HYPOTHESIS', 'SVP_18',
    'SPCATEGORYTYPE', 'eLEXTYPE_PRIVATE1', 'SpObjectTokenCategory',
    'SECFEmulateResult', 'SAFTADPCM_22kHzStereo', 'SVP_19',
    'SpeechAudioFormatGUIDText', 'SpAudioFormat',
    'SpTextSelectionInformation', 'ISpeechVoice', 'DISPID_SOTCId',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SPRuleEngineConfidence', 'SDA_No_Trailing_Space',
    'DISPID_SGRSTRule', 'DISPID_SPPId', 'SpMMAudioEnum',
    'SPBOOKMARKOPTIONS', 'SpeechRecoEvents', 'SAFTADPCM_44kHzMono',
    'SpShortcut', 'DISPID_SpeechAudioBufferInfo',
    'SAFT8kHz8BitStereo', 'SPPHRASEELEMENT', 'SDTAudio',
    'SRSInactive', 'SVPAlert',
    'DISPID_SRCERecognitionForOtherContext',
    'SpeechRegistryLocalMachineRoot', 'ISpResourceManager',
    'DISPID_SVRate', 'SPWT_LEXICAL', 'SWTAdded',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPINTERFERENCE_NONE',
    'SGRSTTTextBuffer', 'SPBINARYGRAMMAR', 'SpPhoneConverter',
    'DISPID_SPEPronunciation', 'DISPIDSPTSI_ActiveOffset',
    'SPCS_ENABLED', 'SAFT16kHz8BitMono', 'DISPID_SGRSTPropertyName',
    'ISpRecoResult', 'DISPID_SLPLangId', 'SSTTTextBuffer',
    'IEnumString', 'SpeechDiscardType',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLWType',
    'ISpeechPhraseReplacement', 'SAFT44kHz8BitMono',
    'DISPID_SVSVisemeId', 'SAFT48kHz8BitMono', 'SVP_17',
    'DISPID_SRCESoundStart', 'SP_VISEME_6', 'SVP_12',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_9',
    'DISPID_SAFGetWaveFormatEx', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpXMLRecoResult', 'ISpeechGrammarRule', 'DISPID_SDKOpenKey',
    'SPEI_TTS_PRIVATE', 'SPWAVEFORMATTYPE', 'DISPID_SpeechVoice',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVIsUISupported', 'UINT_PTR',
    'SpeechWordPronounceable', 'SpeechVoicePriority',
    'SAFT11kHz8BitStereo', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPPEngineConfidence',
    'DISPID_SLPSymbolic', 'SPCONTEXTSTATE', 'DISPID_SLGetWords',
    'DISPID_SDKGetStringValue', 'SPSVerb', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRRTTickCount', 'SpCustomStream', 'SSSPTRelativeToEnd',
    'DISPID_SOTDisplayUI', 'SPAR_High', 'SAFTADPCM_22kHzMono',
    'SVPNormal', 'DISPID_SDKSetBinaryValue',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPGRAMMARWORDTYPE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'STCLocalServer',
    'DISPID_SRCRetainedAudio', 'SRSActiveAlways',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SSFMCreate',
    'DISPID_SRGetPropertyString', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPEsItem', 'DISPID_SGRsFindRule',
    'DISPID_SLGetPronunciations', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SDKDeleteKey',
    'DISPID_SRProfile', 'SPSMF_SAPI_PROPERTIES', 'SVF_Emphasis',
    'SPEVENT', 'SVSFParseMask', 'SpeechCategoryAudioIn',
    'eLEXTYPE_RESERVED4', 'SAFT32kHz16BitMono',
    'DISPID_SRIsUISupported', 'ISpeechObjectTokens', 'SPPS_RESERVED4',
    'SpeechVoiceSkipTypeSentence', 'SpeechPartOfSpeech',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPEAudioSizeTime', 'SVEPhoneme',
    'SPWORDTYPE', 'DISPID_SLRemovePronunciation',
    'eLEXTYPE_PRIVATE16', 'SpeechAudioFormatType',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SOTs_NewEnum', 'DISPID_SRCEBookmark',
    'ISpStreamFormatConverter', 'DISPID_SPRules_NewEnum',
    'ISpeechLexiconWord', 'SVP_2', 'DISPID_SMSAMMHandle',
    'DISPID_SRRAlternates', 'SP_VISEME_7',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRsDynamic',
    'DISPID_SGRSTsItem', 'SPVOICESTATUS', 'SVESentenceBoundary',
    'ISpNotifySource', 'SPEI_RECO_OTHER_CONTEXT', 'SRCS_Enabled',
    'DISPID_SABIEventBias', 'ISpRecognizer', 'SPEI_RESERVED6',
    'SPRECOGNIZERSTATUS', 'STSF_CommonAppData', 'SPDKL_CurrentUser',
    'SAFT11kHz8BitMono', 'SPWORDPRONUNCIATION', 'SVP_15',
    'SPEI_VISEME', 'SGRSTTWildcard',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpPhoneConverter',
    'DISPID_SOTIsUISupported', 'SAFTADPCM_8kHzMono',
    'SPEI_END_INPUT_STREAM', 'DISPIDSPTSI_SelectionLength',
    'SITooQuiet', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SGRSAddRuleTransition', 'SPSHORTCUTPAIRLIST', 'SASClosed',
    'ISpeechRecoContext', 'ISpProperties', 'SRTStandard',
    'SP_VISEME_16', 'SP_VISEME_13', 'SAFTDefault', 'SPPS_Noncontent',
    'DISPID_SPILanguageId', 'SGRSTTWord', 'SGDSInactive',
    'SPPHRASERULE', 'DISPID_SOTDataKey',
    'DISPID_SRGDictationSetState', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVEViseme', 'SPSTREAMFORMATTYPE', 'SVP_3',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechPhraseProperties',
    'SVSFPersistXML', 'SVSFIsFilename', 'SpeechMicTraining',
    'SAFT44kHz8BitStereo', 'ISpNotifySink',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SASetState',
    'DISPID_SGRsCount', 'SPXRO_SML', 'DISPID_SRGCmdLoadFromMemory',
    'SAFT44kHz16BitStereo', 'SPFM_OPEN_READONLY', 'SSTTWildcard',
    'DISPID_SPEAudioStreamOffset', 'SPGS_DISABLED',
    'DISPID_SPIReplacements', 'SPCT_COMMAND', 'ISpeechLexicon',
    'SLTUser', 'DISPID_SRGDictationLoad', 'SECFIgnoreKanaType',
    'DISPID_SPANumberOfElementsInResult', 'SPVPRI_NORMAL',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRRSaveToMemory',
    'eLEXTYPE_RESERVED10', 'SAFT8kHz16BitMono', 'SPGS_ENABLED',
    'DISPID_SWFEExtraData', 'ISpeechResourceLoader', 'SSTTDictation',
    'SRAORetainAudio', 'DISPID_SVSInputWordLength',
    'IEnumSpObjectTokens', 'DISPID_SPRuleId', 'SPEI_MAX_TTS',
    'SAFTADPCM_8kHzStereo', 'SPEI_ADAPTATION', 'DISPID_SLWsItem',
    'SRSEIsSpeaking', 'DISPID_SRGState', 'SVSFVoiceMask',
    'DISPID_SPRuleName', 'SINone', 'SPSModifier',
    'SRERecoOtherContext', 'SpResourceManager',
    'DISPID_SpeechLexicon', 'SpeechVoiceSpeakFlags',
    'ISequentialStream', 'SpMMAudioIn', 'SAFTNoAssignedFormat',
    'DISPID_SRCRequestedUIType', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SAFType', 'SVP_1', 'SPAS_RUN',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechCategoryRecoProfiles',
    'ISpeechWaveFormatEx', 'DISPID_SAFGuid', 'SpeechAudioVolume',
    'DISPID_SpeechPhoneConverter', 'SWTDeleted',
    'DISPID_SOTGetDescription', 'SPDATAKEYLOCATION',
    'ISpeechBaseStream', '_ISpeechVoiceEvents',
    'DISPID_SpeechWaveFormatEx', 'SPPS_Verb',
    'DISPID_SRCEEnginePrivate', 'SRTEmulated', 'SPBO_AHEAD',
    'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE11', 'SECFIgnoreWidth',
    'ISpMMSysAudio', 'DISPID_SVGetProfiles', 'ISpeechDataKey',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRRDiscardResultInfo', 'SPPS_RESERVED1',
    'SpeechRegistryUserRoot', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SDTAlternates', 'SDTAll', 'SPLOADOPTIONS',
    'DISPID_SpeechRecoContext', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRs_NewEnum', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCERecognition',
    'DISPID_SRGCommit', 'SPEI_WORD_BOUNDARY', 'DISPID_SVPriority',
    'eLEXTYPE_RESERVED6', 'SpeechTokenKeyUI', 'ISpDataKey',
    'DISPID_SPPs_NewEnum', 'DISPID_SRGetFormat', 'ISpObjectToken',
    'SPPS_RESERVED2', 'SDKLLocalMachine', 'eLEXTYPE_RESERVED7',
    'ISpeechLexiconWords', 'SPRS_ACTIVE', 'SREPhraseStart',
    'SpeechVisemeFeature', 'eLEXTYPE_PRIVATE5'
]

_check_version('1.1.14', 1669843157.775898)
